...
class BamlAsyncClient:
    ...
    async def TestUniverseQuestion(
      ...
      return cast(types.UniverseQuestion, raw.cast_to(types, types))
...
class BamlStreamClient:
    ...
    def TestUniverseQuestion(
      ...
      return baml_py.BamlStream[partial_types.UniverseQuestion, types.UniverseQuestion](
        raw,
        lambda x: cast(partial_types.UniverseQuestion, x.cast_to(types, partial_types)),
        lambda x: cast(types.UniverseQuestion, x.cast_to(types, types)),
        self.__ctx_manager.get(),
      )
