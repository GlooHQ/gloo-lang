...
export class BamlAsyncClient {
  ...
  async TestUniverseQuestion(
    ...
    try {
      ...
      return raw.parsed() as UniverseQuestion
    } catch (error: any) {
      const bamlError = createBamlValidationError(error);
      if (bamlError instanceof BamlValidationError) {
        throw bamlError;
...
class BamlStreamClient {
  ...
  TestUniverseQuestion(
      question: UniverseQuestionInput,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry }
  ): BamlStream<RecursivePartialNull<UniverseQuestion>, UniverseQuestion> {
    try {
      const raw = this.runtime.streamFunction(
        "TestUniverseQuestion",
        {
      ...
      return new BamlStream<RecursivePartialNull<UniverseQuestion>, UniverseQuestion>(
        raw,
        (a): a is RecursivePartialNull<UniverseQuestion> => a,
        (a): a is UniverseQuestion => a,
        this.ctx_manager.cloneContext(),
        __baml_options__?.tb?.__tb(),
      )
    } catch (error) {
