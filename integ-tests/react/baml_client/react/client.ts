...
import {
  ...
  TestVertexAction,
  TestVertexWithSystemInstructionsAction,
...
export function useNullLiteralClassHello(
    ...
    typeof props
> {
    return useLLM(NullLiteralClassHelloAction, props);
}
...
export function useTestVertexWithSystemInstructions(
    ...
    typeof props
> {
    return useLLM(TestVertexWithSystemInstructionsAction, props);
}
