...
function ResponseCard({ hookResult }: ResponseCardProps) {
  const { isPending, error, isError, status, data, partialData } = hookResult
  ...
  return (
    <Card className='w-full'>
      ...
      <CardContent>
        ...
        <ResponseCard hookResult={streamingDirectAction} status={status} />
      </CardContent>
    </Card>
  )
}
