...
pub use self::workspace::DocumentQuery;
...
pub struct DocumentSnapshot {
    ...
    document_ref: workspace::DocumentQuery,
    position_encoding: PositionEncoding,
}
...
impl Session {
    pub fn new(
        ...
        Ok(Self {
            position_encoding,
            index: workspace::Index::new(workspaces, &global_settings)?,
            global_settings,
...
impl DocumentSnapshot {
    ...
    pub fn query(&self) -> &workspace::DocumentQuery {
        &self.document_ref
    }
