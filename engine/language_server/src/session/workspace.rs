...
use crate::baml_linter;
use crate::edit::LanguageId;
use crate::server::{Workspace, Workspaces};
pub(crate) use crate::session::ruff_settings::RuffSettings;
use crate::{
...
struct WorkspaceSettings {
    ...
    ruff_settings: crate::session::ruff_settings::RuffSettingsIndex,
}
    ...
    pub(super) fn reload_settings(&mut self, changes: &[FileEvent]) {
        ...
        for change in changes {
                ...
                .rev()
            {
                ...
                settings.ruff_settings = crate::session::ruff_settings::RuffSettingsIndex::new(
                    root,
...
impl WorkspaceSettingsIndex {
    ...
    fn register_workspace(
        ...
        let workspace_settings_index = crate::session::ruff_settings::RuffSettingsIndex::new(
            &workspace_path,
...
impl DocumentQuery {
    ...
    pub(crate) fn make_source_kind(&self) -> baml_linter::source_kind::SourceKind {
        match self {
            Self::Text { document, .. } => {
                baml_linter::source_kind::SourceKind::Python(document.contents().to_string())
            }
        }
    }
