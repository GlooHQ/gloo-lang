...
impl Server {
    ...
    fn server_capabilities(position_encoding: PositionEncoding) -> types::ServerCapabilities {
        types::ServerCapabilities {
            ...
            // Some(types::OneOf::Left(NotebookDocumentSyncOptions {
            //     save: Some(false),
...
impl SupportedCodeAction {
    ...
    fn to_kind(self) -> CodeActionKind {
        match self {
            ...
            Self::SourceFixAll => crate::SOURCE_FIX_ALL_BAML,
            Self::SourceOrganizeImports => crate::SOURCE_ORGANIZE_IMPORTS_BAML,
            Self::NotebookSourceFixAll => crate::NOTEBOOK_SOURCE_FIX_ALL_BAML,
            Self::NotebookSourceOrganizeImports => crate::NOTEBOOK_SOURCE_ORGANIZE_IMPORTS_BAML,
        }
    }
