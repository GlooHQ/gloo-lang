...
const getHistoryButtonColor = (
  ...
  const baseClasses = isSelected
    ? {
        ...
        success:
          "bg-green-300 text-green-950 dark:bg-green-700 dark:text-green-50",
        warning:
    ...
    : {
        running:
          "border-blue-200 border hover:bg-blue-100 dark:border-blue-700/50 dark:hover:bg-blue-800/80",
        error:
          "border-red-200 border hover:bg-red-100 dark:border-red-800/50 dark:hover:bg-red-900/80",
        success:
          "border-green-200 border hover:bg-green-100 dark:border-green-700/50 dark:hover:bg-green-800/80",
        warning:
          "border-yellow-200 border hover:bg-yellow-100 dark:border-yellow-700 dark:hover:bg-yellow-800",
        default:
          "border-gray-200 border hover:bg-gray-100 dark:border-gray-700/50 dark:hover:bg-gray-800/80",
      };
