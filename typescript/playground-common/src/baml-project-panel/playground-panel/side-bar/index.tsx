    ...
    return (
      <>
        <Button
          variant="ghost"
          size="sm"
          className="flex absolute top-0 right-1 gap-2 items-center text-muted-foreground/60"
    ...
    <div className="flex relative h-full">
      ...
      <Popover open={showEnvDialog} onOpenChange={setShowEnvDialog}>
        <PopoverTrigger asChild>
          <Button
            variant="ghost"
            size="sm"
            className="flex absolute bottom-0 right-1 gap-2 items-center text-muted-foreground/60"
            onClick={() => setShowEnvDialog(true)}
          >
            <Settings className="w-4 h-4" />
            <span>API Keys</span>
        ...
        <PopoverContent className="h-full max-h-[400px] border-[1px] border-gray-200 sm:max-w-[625px]">
          <EnvVars />
        </PopoverContent>
      </Popover>
      ...
      <div
        className={cn(
          ...
          isOpen
            ? "opacity-100 w-[160px] min-w-[160px]"
