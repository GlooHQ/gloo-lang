...
1. **An amazingly fast developer experience** for prompting in BAML's VSCode LLM Playground
...
2. **State-of-the-art structured outputs** that [outperform other approaches and frameworks](https://www.boundaryml.com/blog/sota-function-calling?q=0) -- that works even better with smaller OpenSource models.
